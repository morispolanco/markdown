...
def add_page_number(footer):
    """Inserta el número de página centrado en el footer."""
...
def setup_styles(doc):
    ...
    # Estilos de Títulos con Color Automático (Negro)
    for i in range(1, 6):
...
def run_book_conversion(md_text, meta, size_option):
    ...
    # --- PÁGINA 3: CONTENIDO (PARA ÍNDICE) ---
    doc.add_page_break()
    ...
    # Espacio para que el usuario inserte el índice
    doc.add_paragraph() 
    ...
    for line in lines:
        ...
        if header_match:
            ...
            if level == 1:
                # Cada Capítulo 1 fuerza una sección nueva en página IMPAR
